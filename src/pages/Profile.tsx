            ...
            <div className="flex-1">
              {isEditing ? (
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">Promedio</label>
                    <Input
                      name="gpa"
                      value={formData.gpa}
                      onChange={handleInputChange}
                ...
                <>
                  ...
                  <p className="text-gray-600 mb-4">{profile.career || 'Sin carrera especificada'}</p>
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="flex items-center gap-2 text-gray-600">
                      <MapPin size={20} />
                      <span>Matrícula: {profile.student_id || 'No especificada'}</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-600">
                      <Building size={20} />
                      <span>Especialidad: {profile.major || 'No especificada'}</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-600">
                      <Mail size={20} />
                      <span>Promedio: {profile.gpa || 'No especificado'}</span>
                    </div>
                  </div>
                </>
              )}
